<template>
  <div class="contain">
    <div class="left" v-show="showLeft">
      ...
      <div class="leftScroll">
        <div class="leftItem">
          <!-- <div>本地音乐</div> -->
          <div
            @click="goRouter(value.routeName)"
            class="leftItemMain"
            v-for="(value,key) in menuItem[0]"
            :key="'a'+key"
          >{{value.name}}</div>
        </div>
        <div class="leftItem">
    ...
    <div class="main">
      <!-- <component :playing="playing" :is="MainPage"></component> -->
      <index-page  v-show="MainPage=='index-page'"></index-page>
      <music-play :playing="playing"  v-show="MainPage=='music-play'"></music-play>
    </div>
    <div class="playMain">
      <div class="playMain1">
        <span @click="goMusicPlay">
          <img id="playMusicIcon" src="http://47.115.124.190/WebView/discovery/d14.jpg" />
        </span>
        <img src="../../img/left.png" />
        <img @click="playOrStop" src="../../img/play.png" />
